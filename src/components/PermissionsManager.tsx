...
const PermissionsManager: React.FC = () => {
  ...
  return (
    <Card sx={{ mb: 3 }}>
      <CardContent>
        ...
        {loading ? (
          ...
          <Typography variant="body2" color="text.secondary">
            No website permissions granted yet. Add sites above to analyze content from those
            domains.
          </Typography>
        ) : (
          <List dense>
            {grantedPermissions.map((permission) => (
              ...
              >
                <ListItemText primary={getDomainFromUrl(permission)} secondary={permission} />
              </ListItem>
            ))}
          </List>
        )}
      ...
      >
        <DialogTitle id="alert-dialog-title">Remove site permission?</DialogTitle>
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            Are you sure you want to remove permission for{" "}
            {deletePermUrl ? getDomainFromUrl(deletePermUrl) : "this site"}? You will need to grant
            permission again to analyze content from this site in the future.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
